...
@configclass
class SlidingExample2EnvCfg(DirectRLEnvCfg):
    # simulation
...
class SlidingExample2Env(DirectRLEnvFeedback):
    cfg: SlidingExample2EnvCfg

    def __init__(self, cfg: SlidingExample2EnvCfg, render_mode: str | None = None, **kwargs):
